// Zoom Punch — letter zoom with wobble and chromatic split
// Adapted from ghostty-shader-playground zoom_and_aberration.glsl (MIT)
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    if (timeSinceChange < 0.0 || timeSinceChange > DURATION) {
        return;
    }
